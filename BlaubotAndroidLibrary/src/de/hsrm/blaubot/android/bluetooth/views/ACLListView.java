package de.hsrm.blaubot.android.bluetooth.views;
...
import de.hsrm.blaubot.android.bluetooth.BlaubotBluetoothDevice;
		...
		this.receiver = (new BroadcastReceiver() {
			...
			public void onReceive(Context context, Intent intent) {
				if (BluetoothDevice.ACTION_ACL_CONNECTED.equals(intent.getAction())) {
					...
					BlaubotBluetoothDevice bbd = new BlaubotBluetoothDevice(device, null);
