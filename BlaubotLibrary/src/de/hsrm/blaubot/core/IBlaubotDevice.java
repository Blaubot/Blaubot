...
public interface IBlaubotDevice extends Comparable<IBlaubotDevice> {
	...
	/**
	 * @return true, if this device is greater or equal to our own hardware device (whatever that means... TODO: define and write documentation)
	 */
	public boolean isGreaterThanOurDevice();
	
	/**
	 * The adapter handling this device and it's connections
	 * 
	 * @return the adapter (bluetooth, wifi, ...) or null, if the device is THIS device
	 */
