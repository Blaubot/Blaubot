...
public interface IBlaubotState {
	...
	/**
	 * Gets called when an {@link AbstractAdminMessage} was received on 
	 * the admin channel.
	 * 
	 * @see AdminChannelFactory
	 * @param adminMessage
	 * @return
	 */
	...
	/**
	 * Gets called if a {@link IBlaubotBeaconInterface} discovered a {@link IBlaubotDevice}.
	 * 
	 * Note:
