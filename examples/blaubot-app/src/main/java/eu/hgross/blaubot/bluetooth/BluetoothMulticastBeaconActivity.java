 ...
 */
public class BluetoothMulticastBeaconActivity extends Activity {
    private static final String LOG_TAG = "BluetoothMulticastBeaconActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mBlaubot = BlaubotAndroidFactory.createBluetoothBlaubotWithMulticastBeacon(DemoConstants.APP_UUID_BLUETOOTH_MULTICAST, 17171, 17172);
